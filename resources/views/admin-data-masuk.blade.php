...
@endphp
<div class="container">
    <h1>Data KK Masuk (belum di-approve)</h1>
    @if ($kk != NULL)
            ...
            <tbody>
                ...
                @foreach ($kk as $item)
                    <tr>
                        ...
                        <td>{{ $item->token }}</td>
                        <td><a href="#" data-toggle="modal" data-target="#editRecord{{$item->id}}" class="btn btn-warning btn-sm btn-action">Approve</a>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content text-gray-800">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a class="btn btn-danger" href="{{ url('admin/'.$current.'/data-masuk/hapus/'.$item->id) }}">Hapus</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal fade" id="editRecord{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content text-gray-800">
                                    ...
                                    <div class="modal-body text-gray-800">
                                        <form action="update-kk" method="POST" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <select id="inputState" class="form-control" name='approval'>
                                                    <option value='1'
                                                    @if($item->approval == '1')
                                                        selected
                                                    @endif
